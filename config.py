...
DB_PASSWORD = os.getenv('TOOL_TOOLSDB_PASSWORD') if curr_env == 'production' else "root"
DB_NAME = f"{DB_USERNAME}__toolwatch" if curr_env == 'production' else "toolwatch_new"
